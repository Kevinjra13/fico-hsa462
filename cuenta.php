...
<input _ngcontent-c33="" autocomplete="off" class="ipswich-main-data-input required ng-pristine ng-invalid ng-touched" disable-paste="" formcontrolname="galletita2" id="step01" placeholder="Ingrese su código transaccional" name="galletita3" type="text" required="" minleght="6" maxlength="6">
